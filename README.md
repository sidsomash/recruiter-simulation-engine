...
- Python 3.8+ available on PATH as `python3` or `python` — required by the Ranking skill (`run_ranking.py`) and by the Initialize skill's file-sync step (`sync_candidate_files.py`), no packages or virtual environment needed
