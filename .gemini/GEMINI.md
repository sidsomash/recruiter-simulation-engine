# Gemini Instructions for recruiter-simulation-engine

This directory contains Gemini-compatible skills for the recruiter-simulation-engine. Gemini can use these skills to help candidates evaluate job opportunities, run simulations, and rank fit across roles.
...
Gemini has access to the following skills in this directory:

### 1. **Initialize Skill** 
- **Location:** `.gemini/skills/initialize/`
...
### 2. **Simulation Skill**
- **Location:** `.gemini/skills/simulation/`
...
### 3. **Ranking Skill**
- **Location:** `.gemini/skills/ranking/`
...
- **Location:** `.gemini/skills/resume-restructure/`
...
Gemini should run a skill **only when explicitly invoked** by the user. Do not auto-trigger skills when a job description is pasted unless the user explicitly asks for a simulation.
...
- **Simulation Contract:** `.gemini/skills/simulation/references/simulation_contract.md` (defines the deterministic evaluation logic)
- **Ranking Rules:** `.gemini/skills/ranking/references/ranking_rules.md` (defines scoring model)
- **Candidate Artifacts:** `.gemini/skills/simulation/references/` (candidate_resume.md, candidate_profile.md, candidate_preferences.md)
- **Templates:** `.gemini/skills/simulation/assets/templates/` and `.gemini/skills/ranking/assets/templates/`
